...
% Computations are repeated 6 times and have a time limit of 4 hours.
%
% MCS computation 
%
% % Content:
...
options.mcs_search_mode = 3; % find the smallest MCS
maxSolutions = 1;
maxCost = 60;
verbose = 1;
...
disp('========')
disp(['Results - smallest MCS - ' coupling ': ' product_rID])
